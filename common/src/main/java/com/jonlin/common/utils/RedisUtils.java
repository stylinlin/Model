...
public class RedisUtils {
    ...
    /**  App过期时长，单位：秒 */
    public final static long APP_EXPIRE = 60 * 60 * 24 * 30;
    /**  智运令牌 token 过期时长，单位：秒 */
    public final static long SINOIOV_TOKEN_EXPIRE = 60 * 60 * 24 * 2;
...
//    {
//        return  set(key.getBytes(), SerializeUtil.serialize(object));
//    }
//
//    /**get Object*/
